...
For Vercel deployment, connect your repository and set environment variables in the dashboard.
...
Contributions are welcome! Please follow the project's coding standards and create a pull request with detailed descriptions.
